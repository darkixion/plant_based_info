...
const BUILTIN_LENSES = [
  ...
  { id: "carbs", name: "Fibre & Carbohydrates", ids: ["carbs","fiber","solfibre","insolfibre","resstarch","starch","sugars","fructose","glucose","sucrose","inulin","raffinose","stachyose"],
  ...
  { id: "antiox", name: "Antioxidants", ids: ["vitc","vite","se","betacar","luteinzea","lycopene","anthocyanidins","flavan3ols","flavonols","coq10","coq9","melatonin","squalene","ergothioneine"],
    why: "Nutrients and bioactive compounds that limit oxidative damage." },
  { id: "phyto", name: "Plant Compounds", ids: ["phytosterols","anthocyanidins","flavan3ols","flavonols","lignans","proanthocyanidins","glucosinolates","coq10","coq9","melatonin","squalene","ergothioneine"],
